...
<img style="width: 100%; border-radius: 20px;" src="./img/banner.jpg" alt="Betizazu Alemu name and role with basic contact information" />

<h1 style="margin-bottom: 20px; padding: 20px 0 10px; font-weight: bold;">
...
<!-- <h2 style="border-bottom: none; margin-top: 40px;">
	<code style="padding: 10px 6px;">My Technical Skills</code>
</h2> -->
